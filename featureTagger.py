...
def add_isupper_first_feature(words):
    res = []
    if words['pre']:
        res.append('-1:word.isupper_first=%s' % words['pre'][0].isupper())
    res.append('word.isupper_first=%s' % words['current'][0].isupper())
    if words['next']:
        res.append('+1:word.isupper_first=%s' % words['next'][0].isupper())
